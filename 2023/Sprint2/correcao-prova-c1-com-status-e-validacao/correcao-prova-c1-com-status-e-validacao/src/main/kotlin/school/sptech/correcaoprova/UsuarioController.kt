...
class UsuarioController {
    ...
    /*
É necessário a @Valid antes do objeto que tem as anotações de validação
     */
    @PostMapping
...
//            } ?: return "Usuário ${login} não encontrado"
    ...
    fun autenticar(@RequestBody @Valid usuarioLogin: UsuarioLoginDto): ResponseEntity<UsuarioRespostaDto> {
        val usuarioExistente =
            usuarios.firstOrNull {
